...
class _ReviewState extends State<Review> {
  ...
  void _onWriteReview() async {
    ...
    if (!mounted) return;
    Navigator.pushNamed(context, Routes.writeReview, arguments: widget.item);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text(Translate.of(context).translate('review')),
        actions: [
        ...
        child: BlocBuilder<ReviewCubit, ReviewState>(
          builder: (context, state) {
            ...
            return Padding(
              ...
              child: Column(
                children: <Widget>[_buildRate(rate), Expanded(child: content)],
              ),
            );
          },
        ),
