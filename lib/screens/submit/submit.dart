...
class _SubmitState extends State<Submit> {
  ...
  void _onUploadGallery() async {
    final result = await Navigator.pushNamed(
      ...
      arguments:
          List<ImageModel>.from(_galleryImage).map((item) {
            return ImageModel(id: item.id, thumb: item.thumb, full: item.full);
          }).toList(),
    );
  ...
  Widget _buildGallery() {
    ...
    if (_galleryImage.isNotEmpty) {
      ...
      decorationImage = DecorationImage(
        image: NetworkImage(_galleryImage.first.full),
        fit: BoxFit.cover,
      );
    }
    return InkWell(
  ...
  Widget _buildContent() {
    ...
    Widget icon = Icon(Icons.help_outline, color: Theme.of(context).hintColor);
    if (_time != null) {
            ...
            child: Column(
              ...
              children: [
                ...
                AppTextInput(
                  ...
                  onSubmitted: (text) {
                    Utils.fieldFocusChange(context, _focusTitle, _focusContent);
                  },
                ),
                const SizedBox(height: 16),
                Text(
                ...
                AppTextInput(
                  ...
                  onSubmitted: (text) {
                    Utils.fieldFocusChange(context, _focusZipCode, _focusPhone);
                  },
                  leading: Icon(
                ...
                AppTextInput(
                  ...
                  onSubmitted: (text) {
                    Utils.fieldFocusChange(context, _focusPhone, _focusFax);
                  },
                  leading: Icon(
                ...
                AppTextInput(
                  ...
                  onSubmitted: (text) {
                    Utils.fieldFocusChange(context, _focusFax, _focusEmail);
                  },
                  leading: Icon(
                ...
                AppTextInput(
                  ...
                  onSubmitted: (text) {
                    Utils.fieldFocusChange(context, _focusEmail, _focusWebsite);
                  },
                  leading: Icon(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          AppPickerItem(
                            value: Translate.of(
                              context,
                            ).translate(_bookingStyle),
                            title: Translate.of(
                              context,
                            ).translate('choose_booking_style'),
