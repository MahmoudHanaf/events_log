...
class _BlogDetailState extends State<BlogDetail> {
  ...
  void _onFeedback() async {
    ...
    if (!mounted) return;
    Navigator.pushNamed(context, Routes.writeReview, arguments: widget.blog);
  }

  ///On navigate review
  void _onReview() async {
    Navigator.pushNamed(context, Routes.review, arguments: widget.blog);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text(Translate.of(context).translate('blog')),
        actions: [
          IconButton(
            enableFeedback: true,
            onPressed: () {
