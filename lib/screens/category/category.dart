...
class _CategoryState extends State<Category> {
  ...
  void _onSearch(String text) {
    _categoryCubit.onLoad(item: widget.item, keyword: _textController.text);
  }
    ...
    return BlocBuilder<CategoryCubit, CategoryState>(
      ...
      builder: (context, state) {
        ...
        return Scaffold(
          appBar: AppBar(
            centerTitle: true,
            title: Text(title ?? Translate.of(context).translate('category')),
            actions: <Widget>[
              IconButton(
                enableFeedback: true,
                icon: Icon(_exportIcon(_type)),
