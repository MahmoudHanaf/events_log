...
class Claim extends StatefulWidget {
  const Claim({super.key, required this.item});
...
class _ClaimState extends State<Claim> {
    ...
    if (_success) {
      return Column(
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            Translate.of(context).translate('claim_success_message'),
        ...
        child: Column(
          ...
          children: [
            ...
            AppTextInput(
              ...
              onSubmitted: (text) {
                Utils.fieldFocusChange(context, _focusEmail, _focusMessage);
              },
            ),
            const SizedBox(height: 12),
            AppTextInput(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text(Translate.of(context).translate('claim')),
      ),
