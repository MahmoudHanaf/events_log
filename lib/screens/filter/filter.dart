...
class Filter extends StatefulWidget {
  ...
  const Filter({super.key, required this.filter});
...
class _FilterState extends State<Filter> {
        ...
        child: Column(
          ...
          children: <Widget>[
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Text(
                          Translate.of(
                            context,
                          ).translate(_filter.sort?.title ?? "select_sort"),
                          style: Theme.of(context).textTheme.bodySmall,
                        ),
                      ],
                    ),
            ...
            Wrap(
              spacing: 8,
              children:
                  Application.setting.category.map((item) {
            ...
            Wrap(
              spacing: 8,
              children:
                  Application.setting.features.map((item) {
            ...
            Column(
              ...
              children: <Widget>[
                ...
                Row(
                  ...
                  children: <Widget>[
                    Text('0Km', style: Theme.of(context).textTheme.bodySmall),
                    Text('30Km', style: Theme.of(context).textTheme.bodySmall),
                  ],
                ),
                Slider(
            ...
            Wrap(
              ...
              runSpacing: 8,
              children:
                  Application.setting.color.map((item) {
                    Widget checked = Container();
                    if (_filter.color == item) {
                      checked = const Icon(Icons.check, color: Colors.white);
                    }
                    return InkWell(
                      onTap: () {
                        setState(() {
              ...
              child: IntrinsicHeight(
                child: Row(
                  ...
                  children: <Widget>[
                    Expanded(
                      child: InkWell(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Text(
                              Translate.of(context).translate('start_time'),
                              style: Theme.of(context).textTheme.bodySmall,
                            ),
                            const SizedBox(height: 4),
                            Text(
                    ...
                    VerticalDivider(color: Theme.of(context).disabledColor),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text(Translate.of(context).translate('filter')),
        actions: [
          IconButton(
            onPressed: () {
              setState(() {
