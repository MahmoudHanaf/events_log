...
class ProductDetail4 extends StatefulWidget {
  const ProductDetail4({super.key, required this.item});

  final ProductModel item;

  @override
  State<ProductDetail4> createState() {
    return _ProductDetail4State();
  }
}
...
class _ProductDetail4State extends State<ProductDetail4> {
  ...
  Widget _buildContent(ProductModel? product) {
    ...
    if (product != null) {
      ...
      ///Claim verified
      if (product.claimVerified == true) {
        verify = const Icon(Icons.verified, color: Colors.green);
      }
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: <Widget>[title, favorite],
                      ),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [rating, claim],
                      ),
                      address,
                      category,
                      phone,
