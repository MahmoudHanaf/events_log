                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                DateFormat.yMMMMd().format(item.createDate),
      ...
      builder: (context, state) {
        ...
        Widget content = ListView.separated(
          ...
          itemBuilder: (context, index) {
            return const AppBlogItem(type: BlogViewType.list);
          },
                    ...
                    children: [
                      Stack(
                        children: [
                          ...
                          Positioned(right: 8, top: 8, child: dotCategory),
                        ],
                      ),
                      Stack(
                        children: [
                          ...
                          Positioned(right: 8, top: 8, child: dotSort),
                        ],
                      ),
                    ],
                  ),
