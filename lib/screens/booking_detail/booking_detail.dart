...
class BookingDetail extends StatefulWidget {
  ...
  const BookingDetail({super.key, required this.item});
...
class _BookingDetailState extends State<BookingDetail> {
  ...
  ///Build item info
  Widget _buildItemInfo({required String title, String? value, Color? color}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
    ...
    return BlocBuilder<BookingDetailCubit, BookingDetailState>(
      ...
      builder: (context, state) {
                ...
                children: [
                    ...
                    children: [
                      ...
                      Expanded(
                        child: _buildItemInfo(
                          ...
                          value: Translate.of(
                            context,
                          ).translate(state.item.paymentName),
                        ),
                      ),
                    ],
                  ),
                    ...
                    children: [
                      Expanded(
                        child: _buildItemInfo(
                          ...
                          value: Translate.of(
                            context,
                          ).translate(state.item.transactionID),
                        ),
                      ),
                      const SizedBox(width: 8),
                      Expanded(
                        child: _buildItemInfo(
                          title: Translate.of(context).translate('created_on'),
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: _buildItemInfo(
                          title: Translate.of(context).translate('paid_on'),
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: _buildItemInfo(
                          title: Translate.of(context).translate('created_via'),
                  ...
                  const SizedBox(height: 12),
                  Column(children: _buildResource(state.item)),
                  const SizedBox(height: 12),
                  const Divider(),
                  const SizedBox(height: 12),
                  Text(
        ...
        return Scaffold(
          appBar: AppBar(
            centerTitle: true,
            title: Text(Translate.of(context).translate('booking_detail')),
          ),
