...
class SocialNetwork extends StatefulWidget {
  ...
  @override
  State<SocialNetwork> createState() {
...
class _SocialNetworkState extends State<SocialNetwork> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text(Translate.of(context).translate('social_network')),
        actions: [
          AppButton(
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            AppTextInput(
              hintText: Translate.of(context).translate('input_facebook'),
              onSubmitted: (text) {
                Utils.fieldFocusChange(context, _focusFacebook, _focusTwitter);
              },
            ...
            const SizedBox(height: 4),
            AppTextInput(
              hintText: Translate.of(context).translate('input_twitter'),
              onSubmitted: (text) {
                Utils.fieldFocusChange(context, _focusTwitter, _focusInstagram);
              },
            ...
            const SizedBox(height: 4),
            AppTextInput(
              hintText: Translate.of(context).translate('input_instagram'),
              onSubmitted: (text) {
                Utils.fieldFocusChange(context, _focusInstagram, _focusGoogle);
              },
            ...
            const SizedBox(height: 4),
            AppTextInput(
              hintText: Translate.of(context).translate('input_google'),
              onSubmitted: (text) {
                Utils.fieldFocusChange(context, _focusGoogle, _focusLinkedin);
              },
            ...
            const SizedBox(height: 4),
            AppTextInput(
              hintText: Translate.of(context).translate('input_linkedin'),
              onSubmitted: (text) {
                Utils.fieldFocusChange(context, _focusLinkedin, _focusYoutube);
              },
            ...
            const SizedBox(height: 4),
            AppTextInput(
              hintText: Translate.of(context).translate('input_youtube'),
              onSubmitted: (text) {
                Utils.fieldFocusChange(context, _focusYoutube, _focusTumblr);
              },
            ...
            const SizedBox(height: 4),
            AppTextInput(
              hintText: Translate.of(context).translate('input_tumblr'),
              onSubmitted: (text) {
                Utils.fieldFocusChange(context, _focusTumblr, _focusFlickr);
              },
            ...
            const SizedBox(height: 4),
            AppTextInput(
              hintText: Translate.of(context).translate('input_flickr'),
              onSubmitted: (text) {
                Utils.fieldFocusChange(context, _focusFlickr, _focusPinterest);
              },
            ...
            const SizedBox(height: 4),
            AppTextInput(
              hintText: Translate.of(context).translate('input_pinterest'),
