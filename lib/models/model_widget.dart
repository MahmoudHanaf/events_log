...
enum WidgetType { listing, category, banner, slider, admob, blog }

enum WidgetDirection { horizontal, list, grid }
...
class DefaultWidgetModel extends WidgetModel {
  ...
  DefaultWidgetModel({required this.title, required this.description});
  ...
  factory DefaultWidgetModel.fromJson(Map<String, dynamic> json) {
    ...
    return DefaultWidgetModel(title: title, description: description);
  }
