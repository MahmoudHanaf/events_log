...
import 'package:charging_station/api/http_manager.dart';
...
class Api {
  ...
  static Future<ResultApiModel> requestHome(params) async {
    final result = await httpManager.get(url: home, params: params);
    return ResultApiModel.fromJson(result);
  }
  ...
  static Future<ResultApiModel> requestBlog(params) async {
    final result = await httpManager.get(url: post, params: params);
    return ResultApiModel.fromJson(result);
  }
  ...
  static Future<ResultApiModel> requestListBlog(params) async {
    final result = await httpManager.get(url: listBlog, params: params);
    return ResultApiModel.fromJson(result);
  }
  ...
  static Future<ResultApiModel> requestClaimList(params) async {
    final result = await httpManager.get(url: claimList, params: params);
    return ResultApiModel.fromJson(result);
  }
  ...
  static Future<ResultApiModel> requestPaymentConfig() async {
    final result = await httpManager.get(url: getPaymentConfig, loading: true);
    return ResultApiModel.fromJson(result);
  }
  ...
  static Future<ResultApiModel> requestDeactivate() async {
    final result = await httpManager.post(url: deactivate, loading: true);
    return ResultApiModel.fromJson(result);
  }
  ...
  static Future<ResultApiModel> requestGps() async {
    final result = await httpManager.get(url: gpsPicked, loading: true);
    return ResultApiModel.fromJson(result);
  }
