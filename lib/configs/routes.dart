...
import 'package:charging_station/screens/screen.dart';
...
class Routes {
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case productDetail:
        return MaterialPageRoute(
          builder: (context) {
            ...
            return Application.setting.businessFactory.createProductDetail(
              item,
            );
          },
        );
      ...
      case writeReview:
        return MaterialPageRoute(
          builder: (context) => WriteReview(item: settings.arguments),
        );
      ...
      case categoryPicker:
        return MaterialPageRoute(
          builder: (context) {
            return CategoryPicker(picker: settings.arguments as PickerModel);
          },
          fullscreenDialog: true,
        );
      ...
      case gpsPicker:
        return MaterialPageRoute(
          builder: (context) {
            return GPSPicker(picked: settings.arguments as GPSModel?);
          },
          fullscreenDialog: true,
        );
      ...
      case picker:
        return MaterialPageRoute(
          builder: (context) {
            return Picker(picker: settings.arguments as PickerModel);
          },
          fullscreenDialog: true,
        );
      ...
      case openTime:
        return MaterialPageRoute(
          builder: (context) {
            ...
            return OpenTime(selected: arguments);
          },
          fullscreenDialog: true,
        );
      ...
      case tagsPicker:
        return MaterialPageRoute(
          builder: (context) {
            return TagsPicker(selected: settings.arguments as List<String>);
          },
          fullscreenDialog: true,
        );
      ...
      case webView:
        return MaterialPageRoute(
          builder: (context) {
            return Web(web: settings.arguments as WebViewModel);
          },
          fullscreenDialog: true,
        );
      ...
      case booking:
        return MaterialPageRoute(
          builder: (context) {
            return Booking(id: settings.arguments as int);
          },
        );
      ...
      case bookingDetail:
        return MaterialPageRoute(
          builder: (context) {
            return BookingDetail(item: settings.arguments as BookingModel);
          },
        );
      ...
      case deepLink:
        return MaterialPageRoute(
          builder: (context) {
            return DeepLink(deeplink: settings.arguments as DeepLinkModel);
          },
        );
